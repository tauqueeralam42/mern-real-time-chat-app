...
const EditUserDetails = ({ onClose, user }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Ensure the data object only contains the necessary fields
            const { name, profile_pic } = data
            const payload = { name, profile_pic }
            ...
            console.log('response', response.data) // Log only the data part of the response
